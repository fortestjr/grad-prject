    ...
    try:
        ...
        if isinstance(devices, list):
            ...
            if isinstance(devices_with_issues, list):
                ...
                report = generate_terminal_report(args.subnet, args.vlan_id, devices_with_issues)
                print(report)
            else:
                print(devices_with_issues)  # Print segmentation error
        else:
            print(devices)  # Print scan error
    except Exception as e:
